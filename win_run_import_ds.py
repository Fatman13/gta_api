...
subprocess.call(['python', 'importds.py', '--country', 'Italy'])
subprocess.call(['python', 'importds.py', '--country', 'Netherlands'])
subprocess.call(['python', 'importds.py', '--country', 'Iceland'])
subprocess.call(['python', 'importds.py', '--country', 'Finland'])
# subprocess.call(['python', 'importds.py', '--country', 'Italy'])
subprocess.call(['python', 'importds.py', '--country', 'Ireland'])
subprocess.call(['python', 'importds.py', '--country', 'Switzerland'])
